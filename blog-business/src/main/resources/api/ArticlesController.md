...
```
GET /blog/articles/getArticleList
```
...
| isAsc         | String  | 否  | 排序方向，asc-升序，desc-降序，默认asc                |
| reasonable    | Boolean | 否  | 分页参数合理化，true-合理化处理，false-不进行合理化处理，默认true |
| hotSort       | Boolean | 否  | 按热度排序，默认false                            |
| timeSort      | Boolean | 否  | 按时间排序，默认true                             |
...
```
GET /blog/articles/getArticleDetail/{slug}
```
...
```
GET /blog/articles/getArticleArchives
```
  ...
  "data": [
    {
      ...
      "articlesList": [
        ...
        },
        {
          ...
          "publishDay": 15,
          "publishTime": "2024-01-15 12:00:00"
        }
      ]
    },
    {
      ...
      "articlesList": [
        {
          ...
          "publishDay": 25,
          "publishTime": "2023-12-25 12:00:00"
        }
      ]
    }
  ]
