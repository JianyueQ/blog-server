 ...
 * @author 31373
 */
public class BusinessRabbitMqConstant {
    public static final String FRIEND_LINKS_EXCHANGE = "friend_links_exchange";
    public static final String FRIEND_LINKS_KEY = "friend_links_key";
    public static final String FRIEND_LINKS_QUEUE = "friend_links_queue";
